...
@Component({
  ...
  template: `
    <sj-paper [sj]="[sj.p(2), sj.d('flex'), sj.alignItems('center')]">
      <sj-flex
        useCol
        useGap="comfortable"
        [usePadding]="2"
      ...
      >
        <sj-typography variant="h6" [sj]="[sj.c('dark'), sj.mb(0.5)]">
        ...
        <sj-typography variant="p" [sj]="sj.c('neutral.dark')">
          ...
          symmetric densities (compact, default, comfortable, spacious) to
          preset numeric values (1–12) for richer/asymmetric layouts. Those are
          only quick options, but if full control is needed, it can be achieved
          by using the sj directive padding utilities, either with numeric
          values responding to our spacing system, or with px/rem units.
        </sj-typography>
        ...
        <sj-typography variant="small" [sj]="sj.c('neutral.dark')">
          ...
          consistency across the app. it is a responsive padding ex. xs: 0.5,
          sm: 0.6, md: 0.7, lg: 0.75, xl: 0.9
        </sj-typography>
        <div
          [sj]="[
            sj.d('grid'),
